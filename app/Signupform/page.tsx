...
import { SignupForm } from "@/components/login/signupcomponents/Signup"
  ...
  <nav
      ...
      >
        ...
        <ul className="hidden sm:flex gap-8 font-bold">
          <li className="hover:text-green-600 transition-colors"><a href="/Landingpage">Home</a></li>
          <li className="hover:text-green-600 transition-colors"><a href="/Aboutus">About us</a></li>
        </ul>
